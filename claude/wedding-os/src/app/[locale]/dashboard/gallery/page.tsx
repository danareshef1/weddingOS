...
export default async function DashboardGalleryPage({
  ...
  return (
    <div className="space-y-6">
      <h1 className="font-serif text-3xl font-bold">Gallery Management</h1>

      {pendingImages.length > 0 && (
        <div className="space-y-4">
          <h2 className="text-xl font-semibold">Pending Approval ({pendingImages.length})</h2>
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-semibold">Approved ({approvedImages.length})</h2>
        ...
        {approvedImages.length === 0 && (
          <p className="text-muted-foreground">No approved images yet</p>
        )}
      </div>
    </div>
  );
